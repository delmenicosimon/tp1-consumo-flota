...
public class Viaje {
	public static void main(String args[]) {
		...
		System.out.printf("Camion con patente: %s\n", patente);
		System.out.println("------------------------------------------");
		System.out.printf("|Km recorridos   :     %dkm                \n", kilRecorridos);
		System.out.printf("|Consumo         :     %.2fL/100km         \n", consumoLt);
		System.out.printf("|Km por litro    :     %.2f/L              \n", rendimiento);
		System.out.printf("|Costo total     :    $%.2f                \n", costoCombustible);
		System.out.printf("|Porcentaje carga:     %.2f%%              \n", capacidadPorcentaje);
		System.out.println("------------------------------------------");
	}
}
